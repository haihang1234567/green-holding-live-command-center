...
class Settings(BaseSettings):
    ...
    data_provider:str="MOCK"; live_status_provider:str="MOCK"; active_shop_count:int=1; polling_interval_seconds:int=180; metric_snapshot_interval_seconds:int=180; refund_snapshot_offsets:str="0,1,3,6,12,24,48"; final_snapshot_after_hours:int=168
