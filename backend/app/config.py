...
class Settings(BaseSettings):
    ...
    data_provider:str="MOCK"; live_status_provider:str="MOCK"; active_shop_count:int=1; polling_interval_seconds:int=180; metric_snapshot_interval_seconds:int=180; refund_snapshot_offsets:str="0,1,3,6,12,24,48"; final_snapshot_after_hours:int=168; enable_affiliate_attribution:bool=False
    live_history_lookback_days:int=30; live_history_refresh_hours:int=24
    admin_username:str="admin"; admin_password:str="admin123"; seed_mock_data:bool=True; purge_mock_data:bool=False
    tiktok_shop_base_url:str="https://open-api.tiktokglobalshop.com"; tiktok_shop_auth_url:str="https://auth.tiktok-shops.com/api/v2"; tiktok_shop_app_key:str=""; tiktok_shop_app_secret:str=""; tiktok_shop_access_token:str=""; tiktok_shop_refresh_token:str=""; tiktok_shop_access_tokens_json:str="{}"; tiktok_shop_refresh_tokens_json:str="{}"; tiktok_oauth_state:str=""
    ...
    def active_channel_ids(self)->tuple[int,...]:
        count=max(1,min(self.active_shop_count,2))
        return (self.shop1_channel_id,self.shop2_channel_id)[:count]
