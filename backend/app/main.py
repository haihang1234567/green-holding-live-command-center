...
from .routers import admin,auth,dashboard,data,integrations,mock,reports,sessions,users
...
for router in (auth.router,dashboard.router,sessions.router,admin.router,data.router,integrations.router,reports.router,users.router):app.include_router(router,prefix=settings.api_prefix)
